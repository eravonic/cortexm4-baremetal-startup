Simple baremetal startup code for an Arm Cortex-M4 processor, implemented specifically for a STM32L476RG microcontroller.

The directory "debug" contains useful information for analyzing output section headers and disassembly.
